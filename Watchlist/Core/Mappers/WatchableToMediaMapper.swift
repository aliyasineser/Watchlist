    ...
    static func convertDetail(from: WatchableDetail, type: MediaType) -> MediaDetail? {
        if let movie = from as? MovieDetail {
            return MediaDetail(
                ...
                createdBy: nil, episodeRunTime: nil,
                firstAirDate: nil,
                inProduction: false,
                languages: nil, lastAirDate: nil,
                lastEpisodeToAir: nil,
                name: movie.title,
                nextEpisodeToAir: nil,
                networks: movie.productionCompanies,
                numberOfEpisodes: 1,
                numberOfSeasons: 1,
                originCountry: nil,
                originalName: movie.originalTitle,
            ...
            return MediaDetail(
                ...
                revenue: 0,
                runtime: serie.episodeRunTime?.first,
                spokenLanguages: serie.spokenLanguages,
                status: serie.status, title: serie.name,
                tagline: serie.tagline, video: false,
                ...
                name: serie.name,
                nextEpisodeToAir: serie.nextEpisodeToAir,
